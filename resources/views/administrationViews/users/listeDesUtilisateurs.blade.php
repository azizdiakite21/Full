        ...
        <div class="justify-content-center row  text-center">
            ...
            <div class="container table-responsive data_table m-5">
                <table id="example" class="table table-stripped  table-bordered table-hover mt-5">
                    <thead class="h5 mt-5">
                    <tr class="">
                        <th class="p-4 text-center">Numéro de l'utilisateur</th><th class="p-4 text-center">Nom d'utilisateur</th><th class="p-4 text-center">Nom</th><th class="p-4 text-center">Prénom</th><th class="p-4 text-center">E-mail</th>
                    ...
                    @foreach($users as $user)
                        <tr class="h5">
                            ...
                            @if(\Illuminate\Support\Facades\Auth::user()->can('voyage_delete', \App\Models\Voyage::class))
                            <td>
                                <form action="{{route('editionUser', $user->id)}}" method="get">
                                    @csrf
                            ...
                            <td>
                                <form action="{{route('suppressionUser', $user->id)}}" method="post" onsubmit="return confirmationSuppression()">
                                    @csrf
