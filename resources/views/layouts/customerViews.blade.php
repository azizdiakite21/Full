        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <!--Lien pour l'achat de ticket-->
                    <li class="nav-item">
                        <a id="navbarDropdown" class="nav-link " href="{{ route('lignes') }}" role="button">
                            Achat du ticket
                        </a>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                      ...
                      <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                          <a class="dropdown-item" href="{{ route('colis') }}">
                              Grille tarifaire
                          </a>
                          <a class="dropdown-item" href="/info-colis">
